...
exports.run = async(client, message, args) => {
    const originalEM = new Discord.MessageEmbed()
        .setColor('RANDOM')
        .setAuthor(`GALAXY bot Plugins Commands`,`https://images-ext-1.discordapp.net/external/Vk8OwWQbmZ9T7PWSvc7l4Z6IQ0KCuFJsgoCFHqGIfgU/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/780408136460402738/be0ac2bc8b228bac9fc21e82740e2c30.png?width=601&height=601`)
        .addFields(
